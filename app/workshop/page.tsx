...
export default async function WorkshopPage() {
  const { standards, overrides, totalModels, categoryCounts, classifiedCount, unclassifiedCount } = await getData();
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold mb-1">Workshop Organization</h1>
